                    ...
                    <li key={index+'.'+subIndex} value={index+'.'+subIndex} className="list-group-item">
                        <div>
                            <div className="btn-group pull-right">
                                ...
                                <button onClick={self._delete.bind(self,index+'.'+subIndex)} className="btn btn-default btn-xs">Delete</button>
                            </div>
                            <i className={'fa '+sub.icon}></i> {sub.name}
                        </div>
                        <div className="hide">
                            <div className="row">
                                <div className="col-xs-8">
                                    <div className="form-inline">
                                        <div className="form-group">
                                            <select id={'iconbox-'+index+'-'+subIndex} className="iconpicker form-control" defaultValue={sub.icon}>
                                                {self._iconList()}
                                            </select>
                                        </div>
                                        <div className="form-group">
                                            <input id={'editbox-'+index+'-'+subIndex} className="form-control" type="text" defaultValue={sub.name} onChange={function(){}}/>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xs-4">
                                    <div className="btn-group pull-right">
                                        <button className="btn btn-default" onClick={self._saveEdit.bind(self,index+'-'+subIndex)}>Done</button>
                                        <button className="btn btn-default" onClick={self._cancle.bind(this)}>Cancle</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="panel panel-default">
                        <div className="panel-heading clearfix display">
                            ...
                            <h4 className="panel-title">
                                <i className={'fa '+main.icon}></i> <a data-toggle="collapse" href={'#collapse'+index}>{main.name}</a>
                            </h4>
                        </div>
                        ...
                        <div className="panel-heading clearfix editable hide">
                            <div className="row">
                                ...
                                <div className="col-xs-4">
                                    <div className="btn-group pull-right">
                                        <button className="btn btn-default" onClick={self._saveEdit.bind(self,index+'')}>
                                            Done
                                        </button>
                                        <button className="btn btn-default" onClick={self._cancle.bind(this)}>
                                            Cancle
                                        </button>
                                    </div>
                                </div>
